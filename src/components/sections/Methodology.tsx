        ...
        <ol className="relative grid gap-6 md:grid-cols-5 md:gap-8">
          ...
          {methodologySteps.map((step, index) => (
            ...
            >
              ...
              <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-line bg-white text-sm font-semibold text-ink transition-all duration-300 ease-out group-hover:border-brand group-hover:bg-brand group-hover:text-white group-focus-within:border-brand group-focus-within:bg-brand group-focus-within:text-white">
                {step.step}
              </div>
              <div className="relative space-y-2 transition-colors duration-300 ease-out">
                <h3 className="text-base font-semibold text-ink transition-colors duration-300 ease-out group-hover:text-ink group-focus-within:text-ink">
                  {step.title}
                </h3>
                <p className="text-sm text-ink-3 transition-colors duration-300 ease-out group-hover:text-ink group-focus-within:text-ink">
                  {step.description}
                </p>
              </div>
