      ...
      <Reveal className="mobile-reveal mobile-delay-3">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-[1.1fr_0.9fr] md:py-20">
          ...
          <div className="grid gap-4">
            ...
            <div className="group relative h-48 overflow-hidden rounded-[var(--radius-card)] bg-white p-6 text-ink shadow-soft transition duration-300 ease-out hover:-translate-y-1 hover:shadow-card">
