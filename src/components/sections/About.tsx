      ...
      <Reveal className="mobile-reveal mobile-delay-3 w-full">
        <div className="mx-auto grid w-full max-w-6xl gap-12 px-6 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="relative flex flex-col gap-6 lg:justify-center">
            ...
            {/* Card 2: Philosophy */}
            <div className="relative overflow-hidden rounded-2xl border border-line/60 bg-surface-2/80 p-8 shadow-xl transition-transform duration-500 hover:-translate-y-1">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {trustSignals.map((signal, index) => (
                ...
                >
                  <div className="group h-full rounded-xl border border-line/60 bg-ink/5 p-4 transition-all duration-300 hover:border-brand/50 hover:bg-ink/10 hover:shadow-lg hover:shadow-brand/5">
                    <h3 className="mb-2 text-sm font-semibold text-ink group-hover:text-brand-2">
                      {signal.title}
                    </h3>
                    <p className="text-justify text-xs leading-relaxed text-ink/60 group-hover:text-ink/80">
                      {signal.description}
                    </p>
                  </div>
                </Reveal>
